...
namespace BCC_Bridge.Android
{
	...
	[Register("bcc_bridge.android.HelpAboutFragment")]
	public class HelpAboutFragment : MvxFragment<HelpAboutViewModel>
	{
		// Inflate the view associated with this fragment
		public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
		{
			var ignore = base.OnCreateView(inflater, container, savedInstanceState);
			return this.BindingInflate(Resource.Layout.HelpAboutView, null);
		}
	}
}